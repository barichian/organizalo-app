...
const integrationDetails: { [key: string]: any } = {
  ...
  whatsapp: {
    logo: WhatsappLogo,
    installed: "Activate WhatsApp to sync tasks and receive notifications directly on your phone.",
    notInstalled: "Connect your WhatsApp Business account or scan QR to sync tasks.",
  },
};
